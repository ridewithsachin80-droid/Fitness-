...
import { calcN, calcMicrosFromItems, rowCompliance, WeightTooltip } from '../lib/coach/dayMath.jsx';
import DayDetail from '../components/coach/DayDetail';
import MemberCharts from '../components/coach/MemberCharts';
...
// AddNoteModal removed in Sprint 12b — the Note tab of MemberActionSheet replaced it in 9b.
...
<button onClick={() => setActionTab('note')} data-testid="open-note"
      ...
      <div className="max-w-md mx-auto px-4 pt-4 pb-8 space-y-3">
        ...
        <Card>
          ...
          {logs.length === 0 ? (
            ...
            <>
              ...
              {/* Selected day full detail — components/coach/DayDetail.jsx (Sprint 12b) */}
              {activeLog ? (
                <DayDetail activeLog={activeLog} activeDate={activeDate} memberId={memberId} workoutTick={workoutTick} data={data} />
              ) : (
        ...
        {/* Weight trend + 30-day compliance — components/coach/MemberCharts.jsx (Sprint 12b) */}
        {tab === 'today' && (
          <MemberCharts weightData={weightData} complianceData={complianceData} avg30={avg30} profile={profile} setSelectedLog={setSelectedLog} />
        )}
