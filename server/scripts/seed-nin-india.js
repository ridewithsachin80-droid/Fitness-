...
const FOODS = [
  ...
  ['Cluster Beans (Gavar)',          'ग्वार फली',      'Kothavarangai',       'vegetable', n({ cal:40,  pro:3.2,  carb:10.8, fat:0.4, fiber:4.7, b1:0.09, b2:0.06, b3:0.5,  ca:130, fe:1.0, mg:43,  p:57,  k:153, na:5 })],
  ...
  ['Pointed Gourd (Parwal)',         'परवल',           'Kovakkai',            'vegetable', n({ cal:20,  pro:2.0,  carb:4.2,  fat:0.3, fiber:3.0, b1:0.05, b2:0.06, b3:0.5,  ca:30,  fe:1.7,  mg:16,  p:40,  k:83,  na:3,   vit_c:29 })],
