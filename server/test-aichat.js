/**
 * test-aichat.js — end-to-end tests for the new AI chat coach endpoints
 * against a real PostgreSQL. Run from server/ with:
 *   DATABASE_URL=postgres://fituser:fitpass@localhost:5433/fitdb JWT_SECRET=testsecret node test-aichat.js
 */
